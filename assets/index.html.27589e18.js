...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>以上语句应该很全面了，可以应对大部分的应用场景。</p>`,38);function b(x,p){const n=r("ExternalLinkIcon");return s(),d("div",null,[i("p",null,[e("如果您对Git还不够了解，请先阅读一下文章"),c,i("a",u,[e("Git菜鸟教程"),l(n)]),e(" 或者 "),i("a",o,[e("Git廖雪峰版本"),l(n)]),m,e(" 建议先学习廖雪峰的版本...")]),g])}const f=a(v,[["render",b],["__file","index.html.vue"]]);export{f as default};
